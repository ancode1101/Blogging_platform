    ...
    <div className={styles.container}>
      ...
      <div className={styles.links}>
        <div className={styles.list}>
          ...
          <Link href="http://localhost:3000/">Homepage</Link>
          <Link href="http://localhost:3000/write">Write</Link>
          <Link href="/">About</Link>
          <Link href="/">Contact</Link>
        </div>
        <div className={styles.list}>
          <span className={styles.listTitle}>Tags</span>
          <Link href="http://localhost:3000/blog?cat=style">Style</Link>
          <Link href="http://localhost:3000/blog?cat=Fashion">Fashion</Link>
